...
$options['shell-aliases']['dev:pl'] = '!SCRIPT=dev:pl ./themes/custom/contenta_theme/scripts/build.sh';
$options['shell-aliases']['dev:theme'] = '!SCRIPT=dev ./themes/custom/contenta_theme/scripts/build.sh';

$options['shell-aliases']['build:drupal'] = '! cd $(readlink -f `pwd`)/.. && composer install --ignore-platform-reqs';
$options['shell-aliases']['build:theme'] = '! ./themes/custom/contenta_theme/scripts/build.sh';
$options['shell-aliases']['build:pl'] = '! composer install -d themes/custom/contenta_theme/pattern-lab --no-interaction && php themes/custom/contenta_theme/pattern-lab/core/console --generate';
